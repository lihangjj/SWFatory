                ...
                <div class="panel-body">
                    <ul>
                        <c:forEach items="${allNews}" var="news">
                            <li><a href="news/show.action?nid=${news.nid}"><span
                                    class="glyphicon glyphicon-exclamation-sign text-danger"></span>&nbsp;【<fmt:formatDate
                                    value="${news.pubdate}" pattern="yyyy-MM-dd"/>】${news.title}</a></li>
                        </c:forEach>
                    </ul>
