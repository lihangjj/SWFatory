    ...
    <div id="newsDiv" class="row">
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading"><strong><span class="glyphicon glyphicon-bullhorn"></span>&nbsp;信息查看</strong>
                </div>
                <div class="panel-body">
                    <div class="text-center h2">${news.title}</div>
                    <div class="text-primary"><strong>新闻摘要：</strong>${news.abs}</div>
                    <div class="text-primary"><strong>发布日期：</strong><fmt:formatDate value="${news.pubdate}"
