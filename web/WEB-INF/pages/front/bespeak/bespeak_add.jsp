    ...
    <div id="newsDiv" class="row">
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading"><strong><span class="glyphicon glyphicon-calendar"></span>&nbsp;访问预约</strong>
                </div>
                <div class="panel-body">
                    <div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        <h5><strong><span class="glyphicon glyphicon-warning-sign"></span>&nbsp;请保证资料填写正确！</strong></h5>
                        <hr>
                    ...
                    <form action="<%=bespeakAddUrl%>" id="myform" method="post" class="form-horizontal">
                        ...
                        <div class="form-group" id="schoolDiv">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="school" id="school" class="form-control input-sm"
                        ...
                        <div class="form-group" id="benoteDiv">
                            ...
                            <div class="col-md-5">
                                <textarea rows="6" name="benote" id="benote" class="form-control input-sm"
                                          placeholder="请输入您的相关需求..."></textarea>
                            </div>
                        ...
                        <div class="form-group" id="codeDiv">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="code" id="code" class="form-control input-sm" size="4"
