    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
                    ...
                    <ul class="treeview-menu">
                        <shiro:hasPermission name="member:add">
                            <li class="${param.action=='member:add' ? 'active' : ''}"><a
                                    href="<%=basePath%>admin/member/addPre.action"><i class="fa fa-plus-square"></i>
                                增加用户</a></li>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="member:list">
                            <li class="${param.action=='member:list' ? 'active' : ''}"><a
                                    href="<%=basePath%>admin/member/list.action"><i class="fa fa-list-alt"></i>
                                用户列表</a></li>
                        </shiro:hasPermission>
                    </ul>
                </li>
            ...
            <shiro:hasRole name="news">
                <li class="${param.role=='news' ? 'active' : ''} treeview"><a href="<%=basePath%>pages/back/index.jsp">
            ...
            <shiro:hasRole name="bespeak">
                <li class="${param.role=='bespeak' ? 'active' : ''} treeview"><a href="<%=basePath%>pages/index.jsp"> <i
                    ...
                    <ul class="treeview-menu">
                        <shiro:hasPermission name="bespeak:list">
                            <li class="${param.action=='bespeak:all' ? 'active' : ''}"><a
                                    href="<%=basePath%>admin/bespeak/list.action?type=all"><i
                                    class="fa fa-laptop"></i> 预约报名列表</a></li>
                            <li class="${param.action=='bespeak:new' ? 'active' : ''}"><a
                                    href="<%=basePath%>admin/bespeak/wait.action?type=new"><i
                                    class="fa fa-exclamation-circle"></i> 新的预约报名</a></li>
                            <li class="${param.action=='bespeak:finish' ? 'active' : ''}"><a
                                    href="<%=basePath%>admin/bespeak/finish.action?type=finish"><i
                                    class="fa fa-ticket"></i> 已处理预约报名</a></li>
                            <li class="${param.action=='bespeak:invalid' ? 'active' : ''}"><a
                                    href="<%=basePath%>admin/bespeak/invalid.action?type=invalid"><i
