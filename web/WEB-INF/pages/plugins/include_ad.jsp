...
<div id="carouselMenu" class="carousel slide" data-interval="200" data-wrap="true">
    ...
    <div class="carousel-inner">
        <div class="item active"><a href="http://www.jixianit.com" target="_ablank"><img src="upload/ad/ads-pic-01.jpg"
                                                                                         alt="f1Img"></a></div>
        <div class="item"><a href="http://www.jixianit.com" target="_ablank"><img src="upload/ad/ads-pic-02.jpg"
                                                                                  alt="f2Img"></a></div>
        <div class="item"><a href="http://www.jixianit.com" target="_ablank"><img src="upload/ad/ads-pic-03.jpg"
                                                                                  alt="f3Img"></a></div>
        <div class="item"><a href="http://www.jixianit.com" target="_ablank"><img src="upload/ad/ads-pic-04.jpg"
                                                                                  alt="f4Img"></a></div>
        <div class="item"><a href="http://www.jixianit.com" target="_ablank"><img src="upload/ad/ads-pic-05.jpg"
                                                                                  alt="f5Img"></a></div>
    </div>
    <!-- 轮播（Carousel）导航 -->
