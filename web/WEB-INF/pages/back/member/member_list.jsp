                ...
                <table class="table table-hover">
                    ...
                    <c:forEach items="${allMembers}" var="member">
                        <tr>
                            ...
                            <td id="regdate-${member.mid}"><fmt:formatDate value="${member.regdate}"
                            ...
                            <td>
                                <input type="button" id="changeBut-${member.mid}" name="changeBut-${member.mid}"
                                       value="修改密码" class="btn btn-xs btn-default">
                                <shiro:hasPermission name="member:edit">
                                    <a href="<%=editMemberUrl%>?mid=${member.mid}" id="edit-${member.mid}"
                                       name="edit-${member.mid}" class="btn btn-xs btn-primary">编辑</a>
                                </shiro:hasPermission>
                                <input type="button" id="lockBut-${member.mid}" name="lockBut-${member.mid}"
                                       locked="${member.locked}" value="${member.locked==1?'激活用户':'锁定用户'}"
...
<div class="modal fade" id="memberPasswordInfo" tabindex="-1" aria-labelledby="modalTitle" aria-hidden="true"
     data-keyboard="true">
