            ...
            <div class="panel-body">
                <form action="<%=passwordMemberUrl%>" id="myform" method="post" class="form-horizontal">
                    <div class="form-group" id="oldpasswordDiv">
                        ...
                        <div class="col-md-5">
                            <input type="password" name="oldpassword" id="oldpassword" class="form-control input-sm"
                    ...
                    <div class="form-group" id="confpasswordDiv">
                        ...
                        <div class="col-md-5">
                            <input type="password" name="confpassword" id="confpassword" class="form-control input-sm"
                                   placeholder="请重新输入新的登录密码...">
                        </div>
