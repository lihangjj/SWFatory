    ...
    <div class="content-wrapper">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <form action="<%=editNewsUrl%>" id="myform" method="post" class="form-horizontal"
                    ...
                    <div class="form-group" id="absDiv">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="abs" id="abs" value="${news.abs}" class="form-control input-sm"
                                   placeholder="请输入公告摘要">
                        </div>
                    ...
                    <div class="form-group" id="picDiv">
                        ...
                        <div class="col-md-5">
                            <input type="file" name="pic" id="pic" class="form-control input-sm"
                                   placeholder="请选择公告所需要的图片">
