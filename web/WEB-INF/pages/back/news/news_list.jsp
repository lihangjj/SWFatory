    ...
    <div class="content-wrapper">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <table class="table table-hover">
                    ...
                    <c:forEach items="${allNews}" var="news">
                        <tr id="tr-${news.nid}">
                            ...
                            <td class="text-center"><fmt:formatDate value="${news.pubdate}"
                ...
                <a href="<%=addNewsUrl%>" id="addBtn" class="btn btn-lg btn-primary"><span
                        class="glyphicon glyphicon-plus-sign"></span>&nbsp;发布公告</a>
                <button id="removeBtn" class="btn btn-lg btn-danger"><span class="glyphicon glyphicon-remove"></span>&nbsp;删除公告
                </button>
