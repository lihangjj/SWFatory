                        ...
                        <td colspan="3">
                            ...
                            <shiro:hasRole name="news">
                                <shiro:hasPermission name="news:list">
                                    <button id="createNewsBut" class="btn btn-info btn-lg"><i
                                            class="fa fa-plus-circle"></i>&nbsp;生成公告信息列表
                                    </button>
                                </shiro:hasPermission>
                            </shiro:hasRole>
                            <shiro:hasRole name="bespeak">
                                <shiro:hasPermission name="bespeak:list">
                                    <button id="createBespeakBut" class="btn btn-success btn-lg"><i
                                            class="fa  fa-slideshare"></i>&nbsp;生成预约分类信息
                                    </button>
                                </shiro:hasPermission>
                            </shiro:hasRole>
                        </td>
